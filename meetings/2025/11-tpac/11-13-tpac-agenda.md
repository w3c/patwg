...
2. A DSP view on Attribution API [#64](https://github.com/w3c/patwg/issues/64) @tprieur @alois-bissuel - 45m
4. Finalizing CR Blockers [#66](https://github.com/w3c/patwg/issues/66) - @martinthomson - 1h 30m (expected)
5. BUMPED TO DG: Next Steps to Level 2 [#67](https://github.com/w3c/patwg/issues/67) - @bmcase - 1h (expected)
6. PPA Discussion Topics
   1. ["Discuss" Issues](https://github.com/w3c/ppa/issues?q=state%3Aopen%20label%3A%22discuss%22):
       1. POSTPONED: Optimization Query Evaluation Framework [#60](https://github.com/w3c/patwg/issues/60) @bmcase - 45m
